      ...
      <div className="bg-brand-dark min-h-screen text-white font-sans py-20 md:py-28">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-lg text-brand-muted leading-relaxed">
            Tinggalkan pencatatan manual di grup WA. Kelola tim, hitung koefisien ELO, dan kunci rekam jejak performa digital tim amatir Anda dengan sistem langganan paling transparan.
          </p>
        </div>
